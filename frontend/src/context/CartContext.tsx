  ...
  const [productsCart, setProductsCart] = useState<CartItem[]>([
    {
      ...
      nome: "Camisa IEEE",
      preco: 20.00,
      foto: "https://src1.ilogo.in/new_upload/2022/2805/16537155661621581911988709/1653716198/front_design_idea.webp",
      quantidade: 1,
      media_avaliacao: 7,
      qt_avaliacoes: 120,
      qt_estrelas: 3.5
    },
    {
      ...
      nome: "Copo IEEE",
      preco: 15.00,
      foto: "https://down-br.img.susercontent.com/file/8b0e0db16d0c44bdeeef23c0a4724584",
      quantidade: 3,
      media_avaliacao: 8,
      qt_avaliacoes: 25,
      qt_estrelas: 4
