...
export default function EditProduct() {
    ...
    return (
        <InformationBox className="border-4 border-gray-400 w-fit p-10 m-auto">
            ...
            <form>
                <Input type="text" name="nome" size={30} icon={<AiOutlineEdit size={30} />} placeholder="Digite o nome" className="bg-white" />
                <Input type="number" name="preco" size={30} icon={<AiOutlineEdit size={30} />} placeholder="Quantidade disponível" className="bg-white" />
                <Input type="number" name="preco" size={30} icon={<AiOutlineEdit size={30} />} placeholder="Digite o preço" className="bg-white" />
